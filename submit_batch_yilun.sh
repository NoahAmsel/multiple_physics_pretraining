...
source /ext3/env.sh
conda activate MPP
python train_basic.py --run_name $run_name --config $config --yaml_config $yaml_config 2>&1 --token_mixing_struct $token_mixing_struct --learning_rate $learning_rate
"
